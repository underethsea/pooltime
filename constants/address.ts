...
const ADDRESS: Addresses = {
  ...
  BASE: {
    ...
    BOOSTERS: [ {
        VAULT: "",
        LIQUIDATIONPAIR: "0xf472bBD523fD0EE07F1350748BE2A2CdeC3e4f0f",
        SYMBOL: "boosting",
        NAME: "boosting",
        DECIMALS: 18,
        ASSET: "0x4200000000000000000000000000000000000006",
  ...
  GNOSIS: {
    ...
    VAULTS: [
      ...
      },
      {
        ...
        LIQUIDATIONPAIR: "0x44AD684a79C0977711CC1221601085890bCEA4AC",
        SYMBOL: "przWXDAI",
    ...
    BOOSTERS: [{
        VAULT: "",
        LIQUIDATIONPAIR: "0x9ef6C3dc52bb2EE6426CEF9a1c478c9e0195BfE4",
        SYMBOL: "boosting",
        NAME: "boosting",
        DECIMALS: 18,
  ...
  ETHEREUM: {
    ...
    BOOSTERS: [{
        VAULT: "",
        LIQUIDATIONPAIR: "0xD692b0c5d72319BB133FDB7C0b6D88C2Ee5C2838",
        SYMBOL: "boosting",
        NAME: "boosting",
        DECIMALS: 18,
        ASSET: "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2",
...
const WHITELIST_VAULTS = [
  "0x449b6A60501015C1a8fda6CD97147280F5eb33D7",
  ...
  "0x0045cC66eCf34da9D8D89aD5b36cB82061c0907C", // pool on wl
...
const WHITELIST_REWARDS: {
  ...
  WORLD: [
    {TOKEN: "0x7077C71B4AF70737a08287E279B717Dcf64fdC57",
      SYMBOL: "POOL",
      GECKO: "pooltogether",
      ICON: "https://assets.coingecko.com/coins/images/14003/standard/PoolTogether.png?1696513732",}
  ]
